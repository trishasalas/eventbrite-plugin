...
<ul>
<li>request token endpoint: <code><strong><?php echo esc_url( $base_url . "/request_token.php" ); ?></strong></code></li>
</ul>
...
<h4>Example</h4>
<a href="<?php echo esc_url( $req_req ); ?>"><?php echo esc_html( $req_req ); ?></a>
...
<ul>
<li>access token endpoint: <code><strong><?php echo esc_url( $base_url . "/access_token.php" ); ?></strong></code></li>
</ul>
...
<h4>Example</h4>
<a href="<?php echo esc_url( $acc_req ); ?>"><?php echo esc_html( $acc_req ); ?></a>

<h3>Making Authenticated Calls</h3>
<p>Using your Access Token you can make authenticated calls.</p>

<ul>
<li>api endpoint: <code><strong><?php echo esc_url( $base_url . "/echo_api.php" ); ?></strong></code></li>
</ul>
<p>
...
<h4>Example</h4>
<a href="<?php echo esc_url( $echo_req ); ?>"><?php echo esc_html( $echo_req ); ?></a>

<h3>Currently Supported Signature Methods</h3>
<p>Current signing method is: <?php echo esc_html( $user_sig_method ); ?></p>
<ul>
<?php
