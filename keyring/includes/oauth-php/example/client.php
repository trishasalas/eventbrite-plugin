...
endpoint: <input type="text" name="endpoint" value="<?php echo esc_url( $endpoint ); ?>" size="100"/><br />
...
consumer key: <input type="text" name="key" value="<?php echo esc_attr( $key ); ?>" /><br />
consumer secret: <input type="text" name="secret" value="<?php echo esc_attr( $secret ); ?>" /><br />
...
token: <input type="text" name="token" value="<?php echo esc_attr( $token ); ?>" /><br />
token secret: <input type="text" name="token_secret" value="<?php echo esc_attr( $token_secret ); ?>" /><br />
...
<p>Current signing method is: <?php echo esc_html( $sig_method->get_name() ); ?></p>
<ul>
<?php
